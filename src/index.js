...
var bou = [115.08179, 30.68516, 122.13501, 35.16483];
var Minlevel = 1;
var Maxlevel = 16;
 ...
 */
function allXY(bounding, Minlevel, Maxlevel) {
...
allXY(bou, Minlevel, Maxlevel)
// console.log(all)

var bag = new Bagpipe(100, { timeout: 1000 })
...
function download(x, y, z) {
    ...
    let imgurl = `http://t${ts}.tianditu.gov.cn/DataServer?T=vec_w&x=${x}&y=${y}&l=${z}&tk=${token}`;
